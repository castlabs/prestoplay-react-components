...
declare module '@castlabs/prestoplay' {
  export namespace clpp {
    ...
    type EventCallback = (payload: Event) => void
    ...
    export class Player {
      constructor(element: HTMLElement|string, config?: PlayerConfiguration)
    ...
    /**
     * @see {@link https://demo.castlabs.com/#/docs?q=clpp#PlayerConfiguration}
     */
    export type PlayerConfiguration = Record<string, unknown> & {
      autoplay?: boolean
      muted?: boolean
      drm?: {
        env: string
    ...
    export class ThumbnailsPlugin {
      get(position: number): Promise<Thumbnail|null>
    }
