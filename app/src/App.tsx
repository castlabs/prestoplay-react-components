...
function App() {
  ...
  const [assetId, setAssetId] = useState<number>(getQueryVariable('asset') || 0)
  const [pageId, setPageId] = useState<string>(getQueryVariable('page') || 'basic')
  const [asset, setAsset] = useState<any>(TestAssets[assetId])
